...
import type { AntdIconSelectWidgetProps } from "../types";
import { ValidationTypes } from "constants/WidgetValidation";

class AntdIconSelectWidget<
  T extends AntdIconSelectWidgetProps,
...
> extends BaseWidget<T, K> {
  ...
  componentDidUpdate = (prevProps: AntdIconSelectWidgetProps) => {
  ...
  static getWidgetType(): WidgetType {
    return "ANTD_ICON_SELECT_WIDGET";
  }
}

export default AntdIconSelectWidget;
