...
import SchemaParser, {
  getKeysFromSchema,
} from "widgets/Antd/JSONFormWidget/schemaParser";
import type { Schema } from "widgets/Antd/JSONFormWidget/constants";
import { ARRAY_ITEM_KEY } from "widgets/Antd/JSONFormWidget/constants";
...
import type { JSONFormWidgetProps } from "widgets/Antd/JSONFormWidget/widget";
...
class AntdFieldConfigurationControl extends BaseControl<ControlProps, State> {
  ...
  static getControlType() {
    return "ANTD_FIELD_CONFIGURATION";
  }
}

export default AntdFieldConfigurationControl;
