...
import type { ColumnProperties } from "widgets/Antd/TableWidget/component/Constants";
import { StickyType } from "widgets/Antd/TableWidget/component/Constants";
import {
  createColumn,
  isColumnTypeEditable,
  reorderColumns,
} from "widgets/Antd/TableWidget/widget/utilities";
...
class PrimaryColumnsControlAntd extends BaseControl<ControlProps, State> {
  ...
  static getControlType() {
    return "PRIMARY_COLUMNS_ANTD";
  }
}

export default PrimaryColumnsControlAntd;
